...
with open("reprezentance.csv", "w", newline="", encoding="utf-8") as csvfile: # Odpira novo CSV datoteko za zapisovanje podatkov
    ...
    pisanje.writerow(["Ranking države", "Narod", "Število članov", "Povprečna starost", "Skupna vrednost", "Točke"])  # Zapiše vrstico z imeni stolpcev v CSV datoteko
    ...
    for row in vrstice:     # Zanka za obdelavo vsake vrstice
        ...
        pisanje.writerow([ranking_drzave, narod, stevilo_clanov, povprecna_starost, skupna_vrednost, tocke]) # Zapiše vse podatke o ekipi v CSV datoteko.
